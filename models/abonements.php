<?php
/**
 * Abonements Model for Schedule Component
 * 
 ...
 * @subpackage Components
 */
class SchedulesModelAbonements extends JModel
{
	/**
	 * Abonements data array
	 *
	 * @var array
	 */
	var $_data;
        /**
         * Total number of abonements
         * 
         *  @var int 
         */
        var $_total = null;
	...
	{
		$query = ' SELECT a.*, f.date_to AS f_date_to, f.date_from AS f_date_from, p.date_to AS p_date_to, p.date_from AS p_date_from '
			.' FROM #__schedule_abonements AS a '
                        .' LEFT JOIN #__schedule_freezings AS f ON f.abonement_id = a.id'
                        .' LEFT JOIN #__schedule_prolongations AS p ON p.abonement_id = a.id'
	...
	function getData()
	{
        ...
        */        
        function _buildQueryOrderBy()
        {
            ...
            $orders = array('num', 'sale_date', 'sale_type', 'id');
